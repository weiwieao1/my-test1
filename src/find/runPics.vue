...
//清空
            clear1() {
                this.$set(this.arr,0,'https://image.qqsk.com/brand/1516271241514.png');
                this.Aform0.types = '';
                this.Aform0.aims = '';
            },
            clear2() {
                this.$set(this.arr,1,'https://image.qqsk.com/brand/1516271241514.png');
                this.Aform1.types = '';
                this.Aform1.aims = '';
            },
            clear3() {
                this.$set(this.arr,2,'https://image.qqsk.com/brand/1516271241514.png');
                this.Aform2.types = '';
                this.Aform2.aims = '';
            },
            clear4() {
                this.$set(this.arr,3,'https://image.qqsk.com/brand/1516271241514.png');
                this.Aform3.types = '';
                this.Aform3.aims = '';
            },
            clear5() {
                this.$set(this.arr,4,'https://image.qqsk.com/brand/1516271241514.png');
                this.Aform4.types = '';
                this.Aform4.aims = '';
            },
            sure(){
